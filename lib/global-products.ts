...
export const INDIE_AI_PRODUCTS: readonly IndieProduct[] = [
  ...
  },
  {
    id: "typingmind",
    name: "TypingMind",
    maker: "Tony Dinh / Devuap",
    origin: "越南创始人 · 全球用户",
    productUrl: "https://www.typingmind.com",
    sourceUrl: "https://tonysoftware.com/",
    category: "多模型 AI 工作台",
